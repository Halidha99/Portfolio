...
export default function About(){
    return<selection className="flex flex-col md:flex-row bg-primary px-5">
<div className="md:w-1/2">
<img className='py-5 rounded-full shadow-lg hover:scale-105 transition-transform duration-300' src='/assest/checksyllabus-banner.png' alt='Description' />
</div>
<div className="md: w-1/2 flex justify-center">
<div className="flex flex-col justify-center "> 
<h1 className="text-4xl text-white border-b-4 border-[#03a9f4] text-left mb-5 w-[280px] font-bold "  > Get to Know Me </h1>
<p className="text-white pb-5">I am an undergraduate pursuing 
